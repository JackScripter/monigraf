...
if config['influxdb']['ssl']: client = InfluxDBClient(host=config['influxdb']['server'], port=8086, username=config['influxdb']['username'], password=passdb, ssl=True, verify_ssl=False)
